...
public class AttachmentPageTest extends TestBase {
	
	public static final Logger logger = Logger.getLogger(AttachmentPageTest.class.getName());
	LoginPage loginpage;
