...
public class ProductFeaturesPageTest extends TestBase{
	public static final Logger logger = Logger.getLogger(ProductFeaturesPageTest.class.getName());
	LoginPage loginpage;
	...
	public ProductFeaturesPageTest() {
		super();
	}
